...
<section class="outils-scroll">
    ...
    <div class="outil-card" id="collage">
        ...
        <div class="outil-right">
            <div class="outil-content">
                ...
                <p class="splitting"> Ce qui est aussi extraordinaire avec cette pratique, c’est l’aspect tactile. Manipuler des matériaux, toucher la texture du papier, ressentir la résistance du collage — tout cela stimule des zones de notre cerveau souvent moins sollicitées dans notre vie quotidienne. C’est un véritable geste de méditation active, une façon de se recentrer, de calmer l’esprit en restant concentré sur chaque mouvement.</p>
                ...
                <p class="splitting"> En résumé, le collage en art-thérapie n’est pas qu’une activité créative. C’est une manière profonde de parler sans mots, de se reconnecter à ses émotions, de laisser émerger ce qui est enfoui. C’est un voyage intérieur, une exploration de soi à travers des images, des textures et des couleurs.</p>
            </div>
        </div>
    </div>
    ...
    <div class="outil-card" id="jeu">
        ...
        <div class="outil-right">
            <div class="outil-content">
                <h3>Le jeu de vie</h3>
                <p class="splitting">Ce jeu innovant, crée par Marie Pré à la suite d’un rêve, est composé de 50 cartes proposant des images surprenantes, suggestives ou énigmatiques, qui invite à une exploration intérieure. Chacune de ces images évoque des situations variées, pouvant résonner comme des rêves éveillés, et porter un sens personnel pour chaque individu.</p>
                <p class="splitting"> Ce jeu a pour but premier de soutenir la reconnexion avec ses ressentis profonds afin d’honorer sa vérité intérieure. Dans un contexte où nous sommes constamment bombardés d’images imposées, il offre la possibilité de retrouver autonomie, créativité et liberté imaginative. Il ne s’agit ni d’un oracle ni d’un jeu divinatoire. C’est avant tout un outil d’observation, de partage, et de développement personnel, particulièrement adapté en contexte d’art-thérapie. Chaque joueur, face à ces images, est seul maître de l’interprétation qu’il en fait, ce qui lui permet d’accéder à ses ressentis, ses émotions et ses souvenirs enfouis.</p>
                <p class="splitting">Les bienfaits spécifiques dans le cadre de l’art-thérapie :</p>
                <p class="splitting"> Supports d’expression accessible : Les images offrent un médium non verbal pour exprimer des ressentis difficiles à verbaliser, facilitant la mise en mots ou en images d’émotions profondes</p>
                <p class="splitting"> Renforcement de la connaissance de soi : En identifiant ses réactions et ses interprétations, la personne développe une meilleure compréhension de ses processus internes.</p>
                <p class="splitting"> Stimulation de la créativité : La liberté d’interprétation encourage l’expression authentique, favorisant la libération de l’imaginaire.</p>
                <p class="splitting">Renforcement de l’autonomie : Pouvoir explorer ses perceptions sans jugement extérieur permet de retrouver confiance en sa propre intuition et en ses ressources intérieures.</p>
                <p class="splitting"> Ce jeu propose ainsi une expérience authentique, sans jugement, et vise à soutenir une démarche centrée sur la rencontre sincère avec soi-même. </p>
                <p class="splitting"> Cet outil permet de retrouver autonomie, liberté créative et confiance dans sa perception, tout en favorisant une meilleure connaissance de soi. La diversité des interprétations démontre que chaque regard est unique, révélant la richesse de l’univers intérieur de chacun.</p>
            </div>
        </div>
    </div>
    ...
    <div class="outil-card" id="meditation">
        ...
        <div class="outil-right">
            <div class="outil-content">
                ...
                <p class="splitting">Introduction</p>
                <p class="splitting">Dans notre monde qui tourne à un rythme effréné, où le stress devient presque une compagne quotidienne, il est vital de prendre régulièrement du recul, de se poser, et de se reconnecter à soi-même. La méditation, pratique aussi ancienne qu’universelle, s’est adaptée à notre vie moderne. Grâce à la méditation guidée, accessible et puissante, il devient possible d’entamer un véritable voyage intérieur, qui peut révolutionner votre façon d’aborder chaque instant, chaque projet, chaque création.</p>
                <p class="splitting">Qu’est-ce que la méditation guidée ?</p>
                <p class="splitting">Imaginez avoir à portée de main un coach personnel, une voix bienveillante et rassurante, qui vous accompagne à chaque étape de votre journée. La méditation guidée, c’est précisément cela : une guidance douce pour vous aider à plonger en vous-même, à travers des exercices de pleine conscience, des visualisations ou simplement des respirations profondes. Elle devient un vrai allié pour apaiser votre esprit, calmer le tumulte intérieur, et vous aider à retrouver une clarté, une paix et une présence authentique.</p>
                <p class="splitting"> Les bénéfices concrets </p>
                <p class="splitting">Calmer votre mental et évacuer le stress : La méditation apaise ce flot de pensées qui ne cesse de tourner en boucle, permettant à votre esprit de se recentrer sur ce qui compte vraiment, sur ce qui ressent profondément en vous. Chaque séance devient alors une véritable respiration face au tourbillon du quotidien.</p>
                <p class="splitting"> Se connecter à ses émotions et à ses intuitions : Elle vous invite à écouter ce qui vibre en vous, à capter la sagesse enfouie dans vos ressentis. À force de pratique, vous apprenez à distinguer ce qui est sincère, ce qui vous anime de l’intérieur, plutôt que de vous laisser envahir par des pensées purement rationnelles ou conditionnées.</p>
                <p class="splitting"> Clarifier votre intention et votre vision : La méditation devient un outil précieux pour organiser votre pensée, pour définir précisément ce que vous souhaitez exprimer ou réaliser. Elle vous aide à donner vie à un message clair, puissant, porteur de sens. </p>
                <p class="splitting"> Augmenter votre énergie et votre focus : En recentrant votre mental, la méditation augmente votre disponibilité intérieure, vous permettant de concentrer vos ressources là où elles ont le plus d’impact, avec plus de puissance et de précision.</p>
                <p class="splitting"> Stimuler une créativité spontanée et authentique : Dans cet état d’apaisement, l’inspiration jaillit naturellement. Les images, les idées, les formes viennent à vous avec plus de facilité, de sincérité, sans effort forcé ni blocage. </p>
                <p class="splitting"> En résumé : </p>
                <p class="splitting"> Méditer avant de créer, c’est comme préparer le terrain d’un jardin : cela permet de libérer, d’harmoniser et d’accumuler vos énergies intérieures pour que, lors de la fabrication, chaque geste soit plus précis, plus vibrant, et plus porteur de sens.</p>
                <p class="splitting"> C’est cette étape qui décuple la puissance de votre création, en faisant en sorte que votre oeuvre transmette de façon authentique ce que vous ressentez vraiment au fond de vous.</p>
            </div>
        </div>
    </div>
