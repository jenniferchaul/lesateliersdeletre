    ...
    <div>
      <div class="row">
        ...
        <div class="image-content">
          <img class="img-scroll img-rotate" src="<?= get_theme_file_uri('assets/images/mandala1.png'); ?>" alt="Art-thérapie mandala">
        </div>
      </div>
      ...
      <div class="row reverse">
        ...
        <div class="image-content">
          <img class="img-scroll img-rotate" src="<?= get_theme_file_uri('assets/images/mandala7.png'); ?>" alt="Art-thérapie mandala">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="image-content">
          <img class="img-scroll img-rotate" src="<?= get_theme_file_uri('assets/images/mandala9.png'); ?>" alt="Art-thérapie mandala">
        </div>
      </div>
      ...
      <div class="row reverse">
        ...
        <div class="image-content">
          <img class="img-scroll img-rotate" src="<?= get_theme_file_uri('assets/images/mandala4.png'); ?>" alt="Art-thérapie mandala">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="image-content">
          <img class="img-scroll" src="<?= get_theme_file_uri('assets/images/mandala8.png'); ?>" alt="Art-thérapie mandala">
        </div>
      </div>
      ...
      <div class="row reverse">
        ...
        <div class="image-content">
          <img class="img-scroll img-rotate" src="<?= get_theme_file_uri('assets/images/mandala12.png'); ?>" alt="Art-thérapie mandala">
        </div>
      </div>
    </div>
  </div>
